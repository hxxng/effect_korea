<?
	class DB {
        ...
        function __construct() {
            ...
            mysqli_query($this->connect, "SET SESSION wait_timeout = 28800");
            mysqli_query($this->connect, "SET SESSION interactive_timeout = 28800");
        }
		...
		function select_query($query,$debug=0) {
			...
			while ($data = mysqli_fetch_array($result)) $return[] = $data;

			return $return;
		}

		function select_assoc($query,$debug=0) {
			if($debug=="1") {
				echo $query."<br/>";
				exit;
			}
