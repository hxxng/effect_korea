        ...
        <div class="row">
            <div class="col-12 my-5">
                ...
                <ul class="t_menu">
                    ...
                    <li class="t_active"><a href="/my_orderlist.php"><?=$order?></a></li>
            ...
            <div class="col-12">
                ...
                <div class="mp_order">
                    <div class="order_hd mp_order_hd">
                        ...
                        <button type="button" class="mp_detail" onclick="location.href='my_orderlist_detail.php?ot_code=<?=$row['ot_code']?>&<?=$_get_txt.$_GET['pg']?>';"><?=$detail?><img src="img/arrow_right.png" alt=""></button>
                    </div>
                    <?
                            ...
                            <div class="order_cont_box1">
                                ...
                                <div class="order_cont mp_down_cont">
                                    ...
                                    <?
                                        ...
                                        $url = $url[1];
                                    ?>
                                    <a href="/download.php?type=my&ot_pcode=<?=$row['ot_pcode']?>&s=<?=$url?>">
...
<script>
    ...
    function search_date(date) {
        ...
        location.replace("/my_orderlist.php?search_date="+date+"&s_date="+dateFormat(s_date)+"&e_date="+dateFormat(now));
    }
    ...
    function chk_calendar(type) {
        if(type != 1) {
            ...
            location.replace("/my_orderlist.php?s_date="+$("#datepicker").val().replaceAll(".", "-")+"&e_date="+$("#datepicker2").val().replaceAll(".", "-"));
        }
    }
