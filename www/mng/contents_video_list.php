...
left join category_t a3 on a3.idx = a1.ct_cate_idx2
left join member_t a4 on a4.idx = a1.mt_idx";
$where_query = " where ct_type = 1 and ct_status = 2 ";
                                    ...
                                    <div class="form-group row align-items-center mb-0">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="btn-group" role="group" aria-label="ct_cate_idx">
                                                ...
                                                <?
                                                $query = "select * from category_t where ct_p_idx = 1";
                                ...
                                <li class="list-group-item">
                                    <div class="form-group row align-items-center mb-0">
                                        <div class="col-sm-12 text-center">
                                            ...
                                            <input type="button" class="btn btn-secondary ml-2" value="초기화" onclick="location.href='./contents_video_list.php'" />
                                            <input type="button" class="btn btn-info float-right" value="신규등록" onclick="location.href='./contents_form.php?act=input&ct_type=1'"/>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                            ...
                            if($list) {
                                foreach($list as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <input type="button" class="btn btn-outline-dark btn-sm" value="상세" onclick="location.href='./contents_form.php?act=update&ct_type=1&ct_idx=<?=$row['ct_idx']?>&<?=$_get_txt.$_GET['pg']?>'" />
