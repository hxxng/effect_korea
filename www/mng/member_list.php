...
$query = "select a1.*, a1.idx as mt_idx from member_t a1 where mt_level = 3";
$query_count = "select count(*) from member_t a1 where mt_level = 3";
$where_query = "";
$_where = " and ";

if($_GET['search_txt']!="") {
    if($_GET['sel_search']=="all") {
        $where_query .= $_where."(instr(a1.mt_id, '".$_GET['search_txt']."') or instr(a1.mt_firstname, '".$_GET['search_txt']."') or instr(a1.mt_lastname, '".$_GET['search_txt']."'))";
    } else {
