    ...
    <div class="container">
        <div class="row">
            <div class="col-12 my-5">
                ...
                <ul class="t_menu">
                    <li class="t_active"><a href="/my_subscription.php"><?=$subscription?></a></li>
                    ...
                    <div class="table-responsive-lg">
                        <table class="table history_list text-center">
                            ...
                            ?>
                                <tr>
                                    <td><?=$date?></td>
                                    <td><?=$row_m['mt_membership']?></td>
                                    <td><?=$row_m['mt_payment']?></td>
...
<script>
    ...
    function search_date(date) {
        ...
        location.replace("/my_subscription.php?search_date="+date+"&s_date="+dateFormat(s_date)+"&e_date="+dateFormat(now));
    }
    ...
    function chk_calendar(type) {
        if(type != 1) {
            ...
            location.replace("/my_subscription.php?s_date="+$("#datepicker").val().replaceAll(".", "-")+"&e_date="+$("#datepicker2").val().replaceAll(".", "-"));
        }
    }
</script>
