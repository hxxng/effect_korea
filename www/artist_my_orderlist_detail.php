        ...
        <div class="row">
            <div class="col-12 my-5">
                ...
                <ul class="t_menu">
                    ...
                    <li class="t_active"><a href="/artist_my_orderlist.php"><?=$order2?></a></li>
        ...
        <div class="row">
                ...
                <div class="mp_order_detail">
                    <div class="order_hd d-flex justify-content-between align-items-center">
                        <div class="mp_chk_label">
                            ...
                            <span class="fw_500 order_hd_fs"><?=DateType($order['ot_pdate'])?></span><span class="order_hd_fs2">(<?=$order_code?>: <?=$order['ot_code']?>)</span>
                        </div>
                                    ...
                                    <div class="order_cont_box1">
                                        ...
                                        <div class="order_cont mp_down_cont">
                                            ...
                                            if(date("Y-m-d", strtotime("+2 weeks", strtotime($row_p['ot_pdate']))) < date("Y-m-d", time())) {
                                                ...
                                                $url = $url[1];
                                                ?>
                                                <a href="/download.php?type=artist&ot_pcode=<?=$row_p['ot_pcode']?>&s=<?=$url?>">
            ...
            <div class="col-12 col-lg-6">
                <div class="info_box">
                    ...
                    <ul class="list_style_1">
                        <li>
                            <span><?=$foriener?></span>
                            <p><? if($member_info['mt_local'] == 1) echo lang("local", $_lang, "pay"); else echo lang("foreiner", $_lang, "pay"); ?></p>
                        </li>
                        <li>
            ...
            <div class="col-12">
                <div class="mp_detail_btm">
                    <button type="button" class="btn btn-primary mp_btn" onclick="location.href='artist_my_orderlist.php?<?=$_get_txt?>';"><?=$list_btn?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    function del_order() {
        $.ajax({
            ...
            success: function (d, s) {
                if (d.result == '_ok') {
                    alert(d.msg);
                    location.replace("/artist_my_orderlist.php");
                } else {
                    alert(d.msg);
                }
            },
