...
//		4 => '직접배송',
    ...
    foreach($arr_framerate as $key => $val) {
        if($key>0) {
            $arr_framerate_option .= "<option value='".$key."' >".$val."</option>";
        }
    }
    ...
    $arr_membership_contents = array(
        1 => 'HD영상무제한, 모션, 트랜지션, LUT, 2D 일러스트',
        2 => 'HD영상무제한, 모션, 트랜지션, LUT, 2D 일러스트',
        3 => '4K 영상, 드론 영상, 타입랩스, 3D 일러스트, HD영상, 모션, 트랜지션, LUT, 2D 일러스트',
        4 => '4K 영상, 드론 영상, 타입랩스, 3D 일러스트, HD영상, 모션, 트랜지션, LUT, 2D 일러스트',
    );

    $arr_membership_download = array(
        1 => '4K, 드론, 타임랩스, 3D 일러스트 제외',
        2 => '4K, 드론, 타임랩스, 3D 일러스트 제외',
        3 => '무제한',
        4 => '무제한',
    );

    $arr_membership_use = array(
        1 => '무제한',
        2 => '무제한',
        3 => '무제한',
        4 => '무제한',
    ...
    foreach($arr_bank_useb as $key => $val) {
        if($key>0) {
            $arr_bank_useb_option .= "<option value='".$key."' >".$val."</option>";
        }
    }
